...
def optimize(df: pd.DataFrame, top_n: int = 20):
    ma_list        = [12, 16, 20, 24]          # MA期間
    range_list = [24, 48, 72, 120, 200, 300]
              # Range lookback（1h足 → 1〜3日分くらい）
    low_thr_list = [0.0, 0.2, 0.4, 0.6]          # レンジ下側の割合
    high_thr_list  = [0.8, 0.9]                # レンジ上側の割合
    entry_dc_list  = [0.002, 0.004, 0.006]     # MA乖離 0.2〜0.6%
    tp_list        = [0.003, 0.005, 0.008]     # 利確幅 0.3〜0.8%
    sl_list        = [0.005, 0.01, 0.015]      # 損切り幅 0.5〜1.5%
