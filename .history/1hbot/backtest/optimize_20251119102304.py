...
def optimize_buy_conditions(df):
    ...
    # 探索範囲
    ma_list  = list(range(1, 201, 20))   # MA: 1,11,21,...191
    rng_list = list(range(1, 201, 20))   # Range: same

    tp_list =  [round(x, 3) for x in np.arange(0.001, 1.001, 0.01)]  # TP 0.001〜1.000
    sl_list =  [round(x, 3) for x in np.arange(0.001, 1.001, 0.01)]  # SL 0.001〜1.000
