# live_bot.py
from bitget_api import load_config, get_current_position, place_order
from data_fetch import fetch_1h_candles
from strategy import compute_indicators, decide_signal, calc_order_size, append_trade_log
