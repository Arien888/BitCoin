...
# 15分足なので「時:分」で時間帯のグループを作成（例："14:15"）
...
# 結果表示
print("=== 高値をつけやすい15分足時間帯（過去1年・JST） ===")
...
plt.title("15-Minute Time Slot with Daily High Price Frequency (JST)")
