...
client = BitgetClient(
    key=config["bitget_Unified"]["api_key"],
    secret=config["bitget_Unified"]["api_secret"],
    passphrase=config["bitget_Unified"]["passphrase"],
    is_testnet=config["bitget_Unified"].get("is_testnet", False),  # ← ここで切り替え
)
