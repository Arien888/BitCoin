...
# --- Excel出力先 ---
output_path = os.path.abspath(os.path.join(BASE_DIR, "..", config["order_export"]["output_file"]))
...
with pd.ExcelWriter(output_path, engine="openpyxl", mode="a" if book else "w") as writer:
