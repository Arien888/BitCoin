...
def backtest_wrapper(params):
    ...
    res.update({"MA": ma, "Lookback": lb, "Buy_MA": bm, "Buy_Prev": bp, "Sell_MA": sm, "Sell_Prev": sp})
    return res
...
if __name__ == "__main__":
    ...
    methods = ["mean_above_mean","median_above_mean","mean_below_mean","median_below_mean",
               "mean_above_median","median_above_median","mean_below_median","median_below_median"]
