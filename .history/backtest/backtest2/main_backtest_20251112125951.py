...
if __name__ == "__main__":
    ...
    # --- パラメータ設定 ---
    ma_list = range(11, 17)       # MA期間
    lookback_list = range(11, 17) # Lookback期間
    buy_methods = ["median","mean_above_mean", "median_above_mean"]   # 買い用
    sell_methods = ["median","mean_below_mean", "median_below_mean"]  # 売り用
