...
# パラメータ
ma_periods = list(range(15, 26))  # MA: 15～25
methods = ["mean", "median", "median_avg", "close"]
lookbacks = list(range(10, 31))   # Lookback: 10～30
...
summary_df.to_csv("backtest_summary_1year.csv", index=False)
...
print("個別結果: 'backtest_summary_1year.csv'、最適条件: 'backtest_best_1year.csv'")
print("全銘柄共通の平均Lookback日数（整数）:", avg_lookback)
