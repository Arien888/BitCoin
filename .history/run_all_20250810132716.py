...
# bitget spot
subprocess.Popen(["python", "bitget_auto_rial/auto_spot.py"]).wait()  # bitget spot　oder cancel
subprocess.Popen(["python", "bitget_auto_rial/auto_spot.py"]).wait()  # bitget spotオーダー(取引所移行のためcloseのみ)
