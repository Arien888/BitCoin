...
def read_cancel_list_from_excel(file_path, sheet_name, symbol_col="A", category_col="B"):
...
def main():
    ...
    cancel_entries = read_cancel_list_from_excel(excel_path, sheet_name, symbol_col, category_col)
